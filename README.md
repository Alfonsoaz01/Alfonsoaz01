...
Partner Solutions Architect @ AWS | Building with AI & Cloud

I ship things. Currently obsessed with agentic AI, voice interfaces, and making LLMs actually useful in production.
...
- Agentic AI systems that actually make it to production
